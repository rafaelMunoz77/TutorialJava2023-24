...
public class v01_TablaSimple extends JPanel {
	...
	public v01_TablaSimple () {
		...
		this.add(new JTextArea("JTable construida sin TableModel. Muy f�cil de crear pero con limitaciones. Siempre editable.\n"
				+ "No podemos realizar cambios como incorporar, eliminar o modificar l�neas.\n"
				+ "Pr�cticamente no podemos configurar casi nada, ni crear renderizadores espec�ficos para celdas concretas"), BorderLayout.NORTH);

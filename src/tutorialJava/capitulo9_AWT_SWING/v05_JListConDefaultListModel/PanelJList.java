package tutorialJava.capitulo9_AWT_SWING.v05_JListConDefaultListModel;
...
//		gridBagLayout.rowWeights = new double[]{0.0, 1.0, 0.0};
		...
		// La JList debe ir dentro de un ScrollPane, y se construye con el modelo de JList sobre el que despu�s
		// se agregar�n o eliminar�n provincias.
	...
	private void agregarProvincia () {
		...
		// Aumento el �ndice de la pr�xima provincia a agregar
		this.indiceProximaProvinciaParaAgregar++;
		// Si sobrepasa el l�mite de las provincias posibles, reiniciamos a valor 0 (cero) el �ndice de la pr�xima provincia a agregar
	...
	/**
	 * Para eliminar todas las provincias seleccionadas, deber�amos comenzar desde la �ltima e ir haciendo el barrido hasta la primera.
	 */
